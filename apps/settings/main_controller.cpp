...
constexpr SettingsMessageTree s_symbolRootChildren[3] = {SettingsMessageTree(I18n::Message::SymbolSquareRoot), SettingsMessageTree(I18n::Message::SymbolArgSquareRoot), SettingsMessageTree(I18n::Message::SymbolArgRoot)};
constexpr SettingsMessageTree s_modelMathOptionsChildren[6] = {SettingsMessageTree(I18n::Message::AngleUnit, s_modelAngleChildren), SettingsMessageTree(I18n::Message::DisplayMode, s_modelFloatDisplayModeChildren), SettingsMessageTree(I18n::Message::EditionMode, s_modelEditionModeChildren), SettingsMessageTree(I18n::Message::ComplexFormat, s_modelComplexFormatChildren), SettingsMessageTree(I18n::Message::SymbolMultiplication, s_symbolChildren), SettingsMessageTree(I18n::Message::SymbolRoot, s_symbolRootChildren)};
