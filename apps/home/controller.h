...
private:
  ...
  static constexpr KDCoordinate k_sideMargin = 10;
  static constexpr KDCoordinate k_bottomMargin = 30;
  static constexpr KDCoordinate k_indicatorMargin = 30;
  static constexpr int k_numberOfColumns = 2;
  static constexpr int k_maxNumberOfCells = 16;
  static constexpr int k_cellHeight = 48;
  static constexpr int k_cellWidth = 150;
  ContentView m_view;
