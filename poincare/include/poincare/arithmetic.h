...
public:
  ...
  template<typename T> static Evaluation<T> IMOD(const ExpressionNode &expressionNode, ExpressionNode::ApproximationContext approximationContext);
